...
# Agent: screenshot-analyst

Capture a screenshot and analyze its contents.

## Capture

Run the capture script from the screenshot skill directory:
...
```json
{
  "full_resolution": {"path": ".../screenshot_full.png", "width": 2560, "height": 1440},
  "thumbnail": {"path": ".../screenshot_thumb.png", "width": 480, "height": 270},
  "window": {"matched_name": "My Page - Firefox", "owner": "Firefox", "id": 12345}
}
```

The `window` field only appears in `--mode window`.
