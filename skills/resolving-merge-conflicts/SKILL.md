...
description: Resolve an in-progress Git merge or rebase conflict hunk by hunk from each side's original intent, then verify the integrated result. Use only when Git reports unresolved merge or rebase conflicts.
